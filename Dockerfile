...
ENV THINGS_BOARD_VERSION 3.1.1-sc1
...
RUN apt-get update && \
    ...
    curl -L https://github.com/smartcampusipn/thingsboard/releases/download/v${THINGS_BOARD_VERSION}/thingsboard.deb -o /tmp/thingsboard.deb && \
